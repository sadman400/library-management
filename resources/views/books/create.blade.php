            ...
            <form action="{{ route('books.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('book_copies') is-invalid @enderror" id="book_copies" name="book_copies" value="{{ old('book_copies', 1) }}" min="1" required>
                        @error('book_copies')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('book_pub') is-invalid @enderror" id="book_pub" name="book_pub" value="{{ old('book_pub') }}">
                        @error('book_pub')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('publisher_name') is-invalid @enderror" id="publisher_name" name="publisher_name" value="{{ old('publisher_name') }}">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('copyright_year') is-invalid @enderror" id="copyright_year" name="copyright_year" value="{{ old('copyright_year') }}">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control @error('date_receiver') is-invalid @enderror" id="date_receiver" name="date_receiver" value="{{ old('date_receiver', date('Y-m-d')) }}">
                        @error('date_receiver')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control @error('date_added') is-invalid @enderror" id="date_added" name="date_added" value="{{ old('date_added', date('Y-m-d')) }}">
                        @error('date_added')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
